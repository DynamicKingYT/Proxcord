...
👉 **[Read the Proxcord Wiki Here](https://github.com/DynamicKingYT/Proxcord/wiki)**

### Quick Links:
* [⚙️ Configuration Guide](https://github.com/DynamicKingYT/Proxcord/wiki/Configuration)
* [💬 Localization & Colors](https://github.com/DynamicKingYT/Proxcord/wiki/Localization)
* [🔌 Developer API](https://github.com/DynamicKingYT/Proxcord/wiki/Developer-API)

---

## 📥 Quick Install

1. Download the latest `Proxcord.jar` from [Modrinth](https://modrinth.com/plugin/proxcord).
2. Ensure you have **DiscordSRV** installed on your server.
3. Drop the JAR into your `/plugins` folder and restart the server.
4. Follow the [Wiki Setup Guide](https://github.com/DynamicKingYT/Proxcord/wiki/Configuration) to link your Discord Bot.
